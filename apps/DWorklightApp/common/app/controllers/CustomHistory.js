...
define(["dojo/_base/lang", "dojo/_base/declare", "dapp/Controller", "dapp/utils/hash", "dojo/topic"], function (lang, declare, Controller, hash, topic) {
    ...
    //      Using dapp/controllers/History means you can use the browser back/forward buttons to retrace all of your
    ...
    return declare("dapp/tests/mediaQuery3ColumnApp/controllers/CustomHistory", Controller, {
